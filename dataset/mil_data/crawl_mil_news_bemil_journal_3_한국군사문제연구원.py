...
f = open('./mil_news_data_bemil.txt', 'a', encoding='utf-8')

for pageNum in range(1, pageLimit+1): # 1에서 100까지 10씩 증가 (1, 11, 21, ..., 91)
    print('pageNum : '+str(pageNum))
    
    
    res = requests.get(f"https://bemil.chosun.com/nbrd/bbs/list.html?b_bbs_id=10163&branch=&pn={pageNum}", verify=False)
